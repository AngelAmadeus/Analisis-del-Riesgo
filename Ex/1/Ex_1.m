...
Sigma = [std(TSX) , std(EN) , std(EURCAD)];                              %matriz de desviación estandar
Rendprom = [mean(TSX) , mean(EN) , mean(EURCAD)];                        %matriz de rendimientos promedio
matcorr = xlsread('Datos_Ex_1','Data','L4:N6');     %matriz de correlación
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T=250;                               %Timepo final
...
S1=zeros(N,(n+1));                   %Matriz de tamaño N,n+1 con ceros para meter los resultados del activo 1
...
Desvest1=Sigma(1);                   %Desviación estandar de los rendimientos del Activo 1

S2=zeros(N,(n+1));                   %Matriz de tamaño N,n+1 con ceros para meter los resultados del activo 2
...
Desvest2=Sigma(2);                   %Desviación estandar de los rendimientos del Activo 2

S3=zeros(N,(n+1));                   %Matriz de tamaño N,n+1 con ceros para meter los resultados del activo 3
...
Desvest3=Sigma(3);                   %Desviación estandar de los rendimientos del Activo 3
